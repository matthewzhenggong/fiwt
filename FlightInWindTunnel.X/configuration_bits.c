...
//
//// FGS
//#pragma config GWRP = OFF                // General Segment Write-Protect bit (General Segment is write protected)
//#pragma config GSS = OFF                 // General Segment Code-Protect bit (Standard Security Code protection Enabled)
//#pragma config GSSK = OFF                // General Segment Key bits (General Segment Write Protection or Code Protection is Enabled)
//
//// FOSCSEL
//#pragma config FNOSC = FRCDIVN          // Oscillator Source Selection bits (Internal Fast RC (FRC) Oscillator with postscaler)
...
//
//// FAS
//#pragma config AWRP = OFF                // Auxiliary Segment Write-protect bit (Aux Flash is write protected)
//#pragma config APL = OFF                 // Auxiliary Segment Code-protect bit (Aux Flash Code protect is enabled)
//#pragma config APLK = OFF                // Auxiliary Segment Key bits (Aux Flash Write Protection or Code Protection is Enabled)
